...
class TextObject extends AbstractObject
{
     ...
     * @param bool $verbatim
     *
     * @return \PHPSlack\BlockKit\CompositionObjects\TextObject
     */
    public static function create(string $type = 'plain_text', string $text = '', bool $emoji = false, bool $verbatim = false): TextObject
    {
     ...
     * @return \PHPSlack\BlockKit\CompositionObjects\TextObject
     */
    public static function createMarkdown(string $text = '', bool $emoji = false, bool $verbatim = false): TextObject
    {
        return new self('mrkdwn', $text, $emoji, $verbatim);
    }
